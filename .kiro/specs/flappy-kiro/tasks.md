...
- [x] 1. Scaffold the single HTML file with canvas and constants
...
- [x] 2. Implement asset loading (sprites and audio)
  - [x] 2.1 Load sprite images with fallback
  ...
  - [x] 2.2 Implement AudioManager with graceful fallback
...
- [x] 3. Implement PhysicsEngine
  - [x] 3.1 Implement gravity, flap, and update methods
  ...
  - [x] 3.2 Write property test: gravity monotonically increases downward velocity
  ...
  - [x] 3.3 Write property test: flap always produces upward velocity
  ...
  - [x] 3.4 Write property test: terminal velocity is never exceeded
...
- [x] 4. Implement Character object and InputHandler
  - [x] 4.1 Define Character object
...
- [x] 5. Implement PipeSpawner and pipe scrolling
  - [x] 5.1 Implement PipeSpawner with spawn, scroll, and cleanup
  ...
  - [x] 5.2 Write property test: pipe gap position is always within bounds
...
- [x] 6. Implement CollisionDetector
  - [x] 6.1 Implement AABB overlap and full collision check
  ...
  - [x] 6.2 Write property test: AABB collision detection is symmetric and complete
...
- [x] 7. Implement ScoreManager
  - [x] 7.1 Implement score tracking and reset
  ...
  - [x] 7.2 Write property test: score is monotonically non-decreasing and correct
  ...
  - [x] 7.3 Write property test: score resets to zero on game restart
...
- [x] 8. Checkpoint — Ensure all logic modules pass their tests
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. Implement BackgroundScroller
...
- [x] 10. Implement Renderer
  - [x] 10.1 Implement background and pipe drawing
  ...
  - [x] 10.2 Implement character drawing with sprite selection
  ...
  - [x] 10.3 Write property test: correct sprite selected for velocity direction
  ...
  - [x] 10.4 Implement score and screen overlays
...
- [x] 11. Implement the game loop and state machine
  - [x] 11.1 Wire the game loop with requestAnimationFrame
  ...
  - [x] 11.2 Implement state transitions via InputHandler
...
- [x] 12. Final checkpoint — Ensure all tests pass and the game runs end-to-end
  - Ensure all tests pass, ask the user if questions arise.
